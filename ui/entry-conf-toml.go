...
func debugPrintToml(fileData []byte) {
	...
	fmt.Printf("[情報] Player.InterfaceType=%s\n", tomlTree.Get("Player.InterfaceType").(string))
	fmt.Printf("[情報] Player.User=%s\n", tomlTree.Get("Player.User").(string))
